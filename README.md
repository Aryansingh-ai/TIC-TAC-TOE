simple terminal-based implementation of the classic Tic-Tac-Toe game. Play against another player on the same device. Ideal for beginners learning programming, game logic, and condition checking.
